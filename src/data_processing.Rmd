...
```{r hybama_test}
plot(jitter(hybama_with_metadata$latitude,30)~jitter(hybama_with_metadata$year_collected,5))+abline(a = 35.211106, b = 0, lty = 2)+abline(v = 1953, lty = 2)

str(hybama_with_metadata)

hybama_headers<-ls(hybama_with_metadata)
